...
func (ec *executionContext) field_Mutation_createJobListing_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalOCreateJobListing2ᚖgoᚑgraphqlᚋgraphᚋmodelᚐCreateJobListing(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_updateJobListing_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNUpdateJobListing2goᚑgraphqlᚋgraphᚋmodelᚐUpdateJobListing(ctx, tmp)
	}
...
func (ec *executionContext) unmarshalNUpdateJobListing2goᚑgraphqlᚋgraphᚋmodelᚐUpdateJobListing(ctx context.Context, v interface{}) (model.UpdateJobListing, error) {
...
func (ec *executionContext) unmarshalOCreateJobListing2ᚖgoᚑgraphqlᚋgraphᚋmodelᚐCreateJobListing(ctx context.Context, v interface{}) (*model.CreateJobListing, error) {
	if v == nil {
		return nil, nil
	}
